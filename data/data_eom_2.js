...
const data = {
    ...
    <main>
        ...
        <div><p>Техническая документация необходима на всех этапах жизненного цикла продукта: от его разработки и производства до утилизации и модернизации.</p></div>
    ...
    "index_2":{
        "subtitle": "Установите соответствие между видами технической документации и их предназначением.",
        "step_of_popup": "Установите соответствие между видами технической документации и их предназначением.",
        "test": [{
            "type": 6
        }, {
            ...
            "answers": [
            ['Содержит информацию, необходимую для разработки и сборки систем: чертежи, схемы, спецификации и т.д.'],
            ['Предоставляет алгоритмы взаимодействия с системой, ориентируясь на оптимизацию работы пользователя и минимизацию рисков при применении'], 
            ['Включает рекомендации по обучению персонала, инструкции по применению и методики тестирования'], 
            ['Описывает процессы исследований и инноваций, а также включает аналитические отчеты и результаты исследований'], 
            ['Включает детализированное описание компонентов и их взаимосвязей, что позволяет воплотить задумку, сохраняя возможность для коррекции на различных этапах реализации'],
            ['Устанавливает последовательность действий для реализации отдельных операций в процессе производства или тестирования изделия, с учётом требований к качеству'], 
            ['Описывает восстановительные действия, учитывая сценарии возможных сбоев, с фокусом на максимальную экономию ресурсов и минимизацию времени простоя системы'], 
            ['Описывает шаги по безопасному завершению жизненного цикла системы, регулирует работу с компонентами, требующими специальной обработки или переработки']
        ]
        }, {
            "columns": ["Проектная документация", "Эксплуатационная документация", "Методическая документация", "Научно-техническая документация", "Конструкторская документация", "Технологическая документация", "Ремонтная документация", "Утилизационная документация"]
        }],
    },
    "index_3":{
        "subtitle": "Изучите основные требования к документации.",
        "step_of_popup": "Изучите основные требования к документации.",
        "paragraph_1":[
            {"text2": `
                    <style>
                        .subtitle_wrapper{
                    ...
                    <main>
                        ...
                        <p><b>Эти требования помогают создать эффективную и удобную документацию, которая минимизирует риски ошибок и недопонимания.</b></p>
                    </main>
            `},
        ],
    },
        ...
        "paragraph_1":[{
            ...
            {"text2": `
                    ...
                    <main>
                        ...
                        <div class="one_nine_blue_table_custom_wrapper">
                            <div class="one_nine_blue_header_custom">
                                <div class="one_nine_blue_header_rect_custom">Пример практического применения технического задания</div>
                            </div>
                            <div class="one_nine_blue_table_text_custom">
                        ...
                        <p><b>ТЗ является основой для оценки выполнения проекта, и любые отклонения от него требуют согласования между разработчиком и заказчиком, что делает документ ключевым элементом успешного завершения проекта.</b></p>
                    </main>
            `}
        ],
    },
    "index_6":{
        "subtitle": "Соотнесите разделы технического задания с их описанием.",
        "step_of_popup": "Соотнесите разделы технического задания с их описанием.",
        "test":[
            {"type": 9},
            {"image": true, "image_path": "./content/empty_img.png", "image_sgn": "blablabla"},
            {"description": " "},
    ...
    "index_10":{
        ...
        "test": [{
            ...
            "columns": ["Формат страниц", "Шрифт и размер текста", "Нумерация страниц", "Структура документа", "Графическое оформление", "Ссылки на источники", "Корректировка и исправления", "Качество печати"]
        }],
    },
    "index_11":{
        "subtitle": "Ознакомьтесь с руководством пользователя.",
        "step_of_popup": "Ознакомьтесь с руководством пользователя.",
        "paragraph_1":[{
            "text" : `
                <style>
...
<div class="eleven_nine_wrapper_header">
    <div><img src="./content/pr1191.png" alt="1"><strong>1. Определение и цель</strong></div>
...
<div class="eleven_nine_wrapper_header">
    ...
    <b>3.1. Введение</b>
    <p><strong>Назначение продукта:</strong> Краткое описание того, для чего предназначена программа или система, её основные функции и целевая аудитория.</p>
    <p><strong>Минимальные системные требования:</strong> Введение начинается с указания системных и аппаратных требований, необходимых для работы с продуктом (операционная система, процессор, оперативная память и т.д.).</p>
        ...
        "paragraph_1":[{
            "text2" : `
                ...
                <div class='fourteen_nine_underline_custom'> </div>
                                <div class='fourteen_nine_wrapper_custom'>
                    <div class="fourteen_nine_header_custom">
                        <p><b>Последовательность выполнения <br> работ</b></p>
